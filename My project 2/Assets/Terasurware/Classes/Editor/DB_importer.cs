...
public class DB_importer : AssetPostprocessor {
	private static readonly string filePath = "Assets/Excel/DB.xls";
	private static readonly string exportPath = "Assets/Excel/DB.asset";
